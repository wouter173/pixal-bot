...
const { success, error, noPerms } = require("../utils/embed.js");
const { modlog } = require("../utils/logs.js");

module.exports.run = (msg, args) => {
	if (!msg.member.permissions.has("KICK_MEMBERS")) { return msg.channel.send(noPerms("KICK_MEMBERS", "kick a user.", msg.author)); }
	...
	member.kick(reason)
		.then(() => {
			modlog(msg, success(`Kicked: <@${member.id}>.\nReason: ${reason}.`, msg.author));
